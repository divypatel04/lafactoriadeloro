    ...
    <div className="legal-page">
      <div className="legal-container">
        ...
        <section>
          ...
          <p>
            Welcome to La Factoria Del Oro ("we," "our," or "us"). We are committed to protecting your 
        ...
        <section>
          ...
          <p>
            To exercise these rights, please contact us at privacy@lafactoriadeloro.com
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            ...
            of residence. These countries may have different data protection laws. By using our website, 
        ...
        <section className="gdpr-notice">
          <h2>GDPR Compliance (EU Residents)</h2>
          <p>
          ...
          <p>
            Our lawful basis for processing your data includes: consent, contract fulfillment, legal 
